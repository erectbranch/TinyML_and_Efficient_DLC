...
- **NCHW**
  ...
  - pointer를 1 움직이면, 실제로는 다음 W 차원으로 이동하는 것과 같다.
    ...
    ![NCHW pointer ex](https://github.com/erectbranch/TinyML_and_Efficient_DLC/blob/master/lec17/images/nchw_ex_1.png)
...
- **NHWC**
  ...
  - pointer를 1 움직이면, 실제로는 다음 C 차원으로 이동한다.
    ...
    ![NHWC pointer ex](https://github.com/erectbranch/TinyML_and_Efficient_DLC/blob/master/lec17/images/nhwc_ex_1.png)
...
- **CHWN**
  ...
  - pointer를 1 움직이면, 다음 N 차원으로 이동하게 된다.
    ...
    ![CHWN pointer ex](https://github.com/erectbranch/TinyML_and_Efficient_DLC/blob/master/lec17/images/chwn_ex_1.png)
...
- peak memory: $2 \times C \times H \times W$
  ...
  ![general depthwise](https://github.com/erectbranch/TinyML_and_Efficient_DLC/blob/master/lec17/images/general_depthwise.png)
...
- peak memory: $(1+C) \times H \times W$
  ...
  ![inplace depthwise](https://github.com/erectbranch/TinyML_and_Efficient_DLC/blob/master/lec17/images/inplace_depthwise.png)
